...
parser.add_argument('-i', '--input_dir', default='videos', type=str, help='Path to input directory')
...
parser.add_argument('-n', '--n_frames', default='25', type=int, help='number of frames to track object for')
...
annotation_formats = {'PASCAL_VOC' : '.xml', 'YOLO' : '.txt'}
...
class LabelTracker():
    ...
    def start_tracker(self, json_file_data, json_file_path, img_path, obj, color, annotation_formats):
        ...
        print("Achor id", anchor_id)
        print("frame Data Dict", frame_data_dict)
...
if __name__ == '__main__':
    ...
    class_rgb = [
        (0, 0, 255), (255, 0, 0), (0, 255, 0), (255, 255, 0), (0, 255, 255), (95, 196, 152), (152, 95, 196), (185, 206, 172),
        (255, 0, 255), (0,128,255), (128, 128, 128), (128, 0, 0), (255,0,128), (196,97,140), (139, 196, 35),  
        (128, 128, 0), (0, 128, 0), (128, 0, 128), (0, 128, 128), (0, 0, 128), (95, 139, 196), (196, 152, 95)]
